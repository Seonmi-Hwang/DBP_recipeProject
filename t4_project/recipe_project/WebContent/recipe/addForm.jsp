    ...
    <tr>
	  ...
	  <td>
	    ...
	    <table style="background-color: YellowGreen">
	  	  <tr height="40">
			<td width="150" align="center" bgcolor="E6ECDE">레시피 이름</td>
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
				<input type="text" style="width: 240;" name="recipeName" placeholder="ex)김치찌개">
			</td>
		  </tr>
<!-- 	  <tr height="40">
	  	  ...
	  	  <tr height="40">
			<td width="150" align="center" bgcolor="E6ECDE">소요시간</td>
			<td width="250" bgcolor="ffffff" style="padding-left: 10">
				조리시간 총 <input type="password" style="width: 240" name="time" placeholder="ex)10"> 분 소요
			</td>
		  </tr>
	  	  <tr height="40">
