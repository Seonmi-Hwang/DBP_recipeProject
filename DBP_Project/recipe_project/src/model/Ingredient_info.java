...
public class Ingredient_info {
	...
	public void update(Ingredient_info upingredient_info) {
		this.ingredient_id = upingredient_info.ingredient_id;
		this.icategory = upingredient_info.icategory;
		this.iname = upingredient_info.iname;
	}
